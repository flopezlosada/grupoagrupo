  ...
  public function resetRequestBody($user)
  {
    ...
    try
    {
      $this->mail(array('subject' => sfConfig::get('app_sfApplyPlugin_reset_subject',
        ...
        'fullname' =>$user->getInternalUser()->getFullName(),
        'email' => $profile->getEmail(),
        'parameters' => array('fullname' => $user->getInternalUser()->getFullName(), 'validate' => $profile->getValidate(), 'username' => $user->getUsername()),
