...
<form id=consumer_add_product_form
	action="<?php echo url_for('consumer_group/' . ($form->getObject()->isNew() ? 'addedProduct': 'modifiedProduct') ."?order_id=".$order->id. 
	...
	<ul>
		...
		<li>
    		<?php echo $form['consumer_id']->renderError() ?>    		
    		<?php echo $form['consumer_id']->renderLabel() ?><?php echo $form['consumer_id'] ?>                                
    	</li>
    	<?php endif;?>
    	<li>
