            	...
            	<div class="header_order_list">
            	    ...
            	    <?php foreach ($provider->getOrderState($state->id) as $order):?>
            	    	<div class="content_order" id="content_order_<?php echo $order->id?>">
                			...
                			<span class="order_name large_title <?php echo in_array($state->id,array(4,5,6,7,9,10,11,14)) ? "open_detail open_detail_".$state->id."_".$order->id:""?>">
                			<?php echo $order->name?></span>	
